...
class TestUserDataRepository : UserDataRepository {
    private val _userData = MutableSharedFlow<InternalData>(replay = 1, onBufferOverflow = BufferOverflow.DROP_OLDEST)
    private val _fcmToken = MutableSharedFlow<String>(replay = 1, onBufferOverflow = BufferOverflow.DROP_OLDEST)
